...
# with db.engine.begin() as conn:
#     DO = conn.execute(text(f" execute count_medications(); ")) 
#     conn.commit() 

# with db.engine.begin() as conn:
#     DO = conn.execute(text(f" execute count_departments(); ")) 
#     conn.commit() 

# with db.engine.begin() as conn:
#     DO = conn.execute(text(f" execute count_procedures(); ")) 
#     conn.commit() 

# with db.engine.begin() as conn:
#     DO = conn.execute(text(f" execute count_undergoes(); ")) 
#     conn.commit() 

# with db.engine.begin() as conn:
#     DO = conn.execute(text(f" execute count_prescribes(); ")) 
#     conn.commit() 
